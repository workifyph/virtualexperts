...
import { services, businessProfile } from "@/content/siteData";

export const metadata: Metadata = {
  title: "Services",
  description:
    "Explore VEX managed remote support services — customer support, virtual assistance, back-office operations, on-call VA support, and recruitment.",
};
...
export default function ServicesPage() {
  const jsonLd = {
    ...
    "@type": "Service",
    provider: { "@type": "Organization", name: businessProfile.legalName },
  ...
  return (
    <>
            ...
            {services.map((svc, i) => (
              <ScrollReveal key={svc.slug} delay={i * 100}>
                <div className="vex-card" style={{ display: "flex", flexDirection: "column", height: "100%" }}>
                  ...
                  <p className="vex-card__body" style={{ flex: 1 }}>{svc.shortDesc}</p>
      ...
      {/* Video break */}
      <section className="section-full" aria-label="Our approach">
        <div className="section-media">
